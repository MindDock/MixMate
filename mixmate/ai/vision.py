    ...
    def _parse_response(self, raw: str) -> SceneUnderstanding:
        try:
            ...
            return SceneUnderstanding(
                ...
                is_dancing=data.get("is_dancing", False),
                is_sports=data.get("is_sports", False),
                is_talking=data.get("is_talking", False),
                is_walking=data.get("is_walking", False),
                is_closeup=data.get("is_closeup", False),
                is_landscape=data.get("is_landscape", False),
                is_group_activity=data.get("is_group_activity", False),
                narrative_role=data.get("narrative_role", ""),
                suggested_cut_style=data.get("suggested_cut_style", ""),
